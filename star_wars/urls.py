...
schema_view = get_schema_view(
    openapi.Info(
        title="Star Wars API",
        default_version='v1',
        description="API para aficionados del universo de Star Wars",
        terms_of_service="https://www.linkedin.com/in/jeisson-felipe-manrique-pulido-8055aa126/",
        contact=openapi.Contact(email="jeissonmp15@gmail.com"),
